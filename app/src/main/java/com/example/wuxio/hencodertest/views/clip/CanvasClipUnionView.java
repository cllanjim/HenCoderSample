...
public class CanvasClipUnionView extends View {

    private static final String TAG = CanvasClipUnionView.class.getSimpleName();

    private Paint mPaint = new Paint();
    private float m1dp;

    public CanvasClipUnionView(Context context) {
        super(context);
        init();
    }

    public CanvasClipUnionView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CanvasClipUnionView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.clipRect(40 * m1dp, 40 * m1dp, 100 * m1dp, 100 * m1dp, Region.Op.UNION);
        drawScene(canvas);
        canvas.restore();
    }
